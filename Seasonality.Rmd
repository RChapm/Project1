...
The regression  produced a quadratic trend which concaves down. It suggests that the decrease in the labor force participation rate is accelerating. The amplitude of the oscillation is slowly increasing (0.01-0.02 percentage points per year). The seasonal part suggests that the labor force participation rate is lower than average in summer and higher than average in spring and fall.
